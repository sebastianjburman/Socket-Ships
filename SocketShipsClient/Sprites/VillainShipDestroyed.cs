...
public class VillainShipDestroyed : AnimatedSprite
{
    private bool BulletSide;
    private float ShipHitAnimationDelay;
    private float ShipHitElapsed;

    public VillainShipDestroyed(Vector2 spritePosition, double frameDuration, int frameCount,Guid spriteId, float shipHitAnimationDelay) : base("VillainShip/Destroyed", spritePosition, frameDuration, frameCount, spriteId)
    {
